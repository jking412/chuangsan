    ...
    <div class="show-board" ref="dom">
      ...
      <div class="process">
        <el-table :data="knowledge" stripe style="width: 100%" height="100%">
          <el-table-column prop="name" label="知识点名称" min-width="65%">
          </el-table-column>
          <el-table-column prop="status" label="平均完成度" min-width="35%">
          </el-table-column>
        </el-table>
      </div>
      <div style="font-size: 18px; font-weight: 600; color: #979797;margin: 20px 0px">知识点平均掌握率</div>
  ...
  data() {
    return {
      ...
      knowledge: [
        ...
        { name: '堰流的水力计算', status: '46%' },
        { name: '堰流及闸孔出流的概念', status: '21%' },
        { name: '闸孔出流的水力计算', status: '54%' },
      ]
    }
  },
  mounted() {
